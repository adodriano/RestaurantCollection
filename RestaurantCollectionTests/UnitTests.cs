...
namespace RestaurantCollectionTests
{
    public class UnitTests : IClassFixture<WebApplicationFactory<Program>>, IDisposable
    {
        ...
        [Fact]
        public async Task TestCreateRestaurans_Ok()
        {
            await SeedData();
        ...
        [Fact]
        public async Task TestGetRestaurans_Ok()
        {
            await SeedData();
        ...
        [Fact]
        public async Task TestRestauranById_Ok()
        {
            await SeedData();
        ...
        [Fact]
        public async Task TestGetRestaurantByCity_Ok()
        {
            await SeedData();
        ...
        [Fact]
        public async Task TestNonExistentApi_Ok()
        {
            await SeedData();
        ...
        [Fact]
        public async Task TestGetSortedRestaurantsByRating_Ok()
        {
            await SeedData();
        ...
        [Fact]
        public async Task TestUpdateRestaurant_Ok()
        {
            await SeedData();
        ...
        [Fact]
        public async Task TestGetUpdatedRestaurant_Ok()
        {
            await SeedData();
            // Return with 204 if restaurant is updated 
            var body0 = JsonConvert.DeserializeObject("{\"rating\":\"5\",\"votes\":700}");
        ...
        [Fact]
        public async Task TestDeleteRestaurant_Ok()
        {
            await SeedData();
        ...
        private void SetUpClient()
        {
            Client = _factory.WithWebHostBuilder(builder =>
                builder.UseStartup<RestaurantCollection.Startup>()
